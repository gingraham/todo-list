...
//grab local storage data and store it in todoData
...
function submitTask() {
  //validate first if there is a task entered
  if (todoValue.value.trim() === "") {
    ...
    <div class="todo-controls-container">
        <img class="edit todo-controls" src="assets/images/icons8-edit-94.png" ondblclick="updateToDoItems(this)">
        <img class="delete todo-controls" src="assets/images/icons8-delete-94.png"  ondblclick="deleteTodo(this)">
    </div>`;
...
function completeTodoItem(e) {
  ...
  //if there's no text decoration meaning not complete
  if (e.parentElement.querySelector("div").style.textDecoration === "") {
    //add a red strike through
